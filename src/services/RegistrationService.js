...
const REGISTRATION_API_BASE_URL="http://localhost:8082/rest/inscriptions";
const UNIVERSITY_API_BASE_URL="http://localhost:8082/rest/universities";

// /addinscription


const ADD_REGISTRATION_API_BASE_URL="http://localhost:8082/rest/addinscription";
const GETBYID_REGISTRATION_API_BASE_URL="http://localhost:8082/rest/inscription";
const UPDATE_REGISTRATION_API_BASE_URL="http://localhost:8082/rest/updateinscription";
const DELETE_REGISTRATION_API_BASE_URL="http://localhost:8082/rest/deleteinscription";

///UNIVERSITY
const ADD_UNIVERSITY_API_BASE_URL="http://localhost:8082/rest/adduniversity";
const GETBYID_UNIVERSITY_API_BASE_URL="http://localhost:8082/rest/university";
const UPDATE_UNIVERSITY_API_BASE_URL="http://localhost:8082/rest/updateuniversity";
const DELETE_UNIVERSITY_API_BASE_URL="http://localhost:8082/rest/deleteuniversity";
