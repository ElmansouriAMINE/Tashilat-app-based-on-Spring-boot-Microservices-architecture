                ...
                <form className="navbar-search">
                  <div className="input-group">
                    <input type="text" className="form-control bg-light border-1 small" placeholder="What do you want to look for?"
                      aria-label="Search" aria-describedby="basic-addon2"  sx={{borderColor: "#3f51b5;"}}/>
              ...
              <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="dropdown-list-image mr-3">
                    <img className="rounded-circle" src="img/man.png" sx={{maxWidth: "60px"}} alt=""/>
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="dropdown-list-image mr-3">
                    <img className="rounded-circle" src="img/girl.png" sx={{maxWidth: "60px"}} alt=""/>
              ...
              <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a className="dropdown-item align-items-center" href="#">
                  <div className="mb-3">
                    ...
                    <div className="progress" sx="height: 12px;">
                      <div className="progress-bar bg-success" role="progressbar" sx={{width: "50%"}} aria-valuenow="50"
                ...
                <a className="dropdown-item align-items-center" href="#">
                  <div className="mb-3">
                    ...
                    <div className="progress" sx="height: 12px;">
                      <div className="progress-bar bg-warning" role="progressbar" sx={{width: "30%"}} aria-valuenow="30"
                        aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </a>
                <a className="dropdown-item align-items-center" href="#">
                  <div className="mb-3">
                    ...
                    <div className="progress" sx="height: 12px;">
                      <div className="progress-bar bg-danger" role="progressbar" sx={{width: "75%"}} aria-valuenow="75"
                        aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </a>
