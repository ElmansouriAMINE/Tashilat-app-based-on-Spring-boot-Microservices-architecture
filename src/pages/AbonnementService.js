...
export default class AbonnementService extends Component {
  ...
  counterNumber() {
    ...
    axios({
      ...
      url: "http://localhost:8083/operation/wifi/" + this.state.user.id,
      method: "GET",
    })
  ...
  handleDelete() {
    ...
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/deleteAbonnement/" + this.state.rowId,
      method: "DELETE",
    })
  ...
  handleUpload() {
    this.setState({ abonnementId: document.getElementById('abonnementId').value }, () => {
      ...
      axios({
        // Endpoint to send files
        url: "http://localhost:8086/userAbonnement/getAbonnemntsByMatricule/" + this.state.abonnementId,
        method: "GET",
      })
  ...
  handleUploadP() {
    axios({
      ...
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/getAbonnemntsPayeByMatricule/" + this.state.abonnementId,
      method: "GET",
    })
  ...
  handleUploadNonP() {
    axios({
      ...
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/getAbonnemntsNonPayeByMatricule/" + this.state.abonnementId,
      method: "GET",
    })
