          ...
          <div class="col-lg-6">
              <div class="card shadow-sm mb-4">
                ...
                <div class="btn-group dropright " style={{width:"10%"}}>
                        ...
                        <div class="dropdown-menu ">
                          ...
                          <a class="dropdown-item" href="/electric-service">electric statistics</a>
                        </div>
                      </div>
            ...
            <div class="col-lg-6">
              <div class="card shadow-sm mb-4">
                ...
                <button type="button" class="btn btn-primary mb-1"><a style={{color:"white"}} href="/user statistic">show statistics</a></button>
                </div>
              </div>
            </div>
          </div>
