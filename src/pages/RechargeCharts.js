...
export default function RechargeCharts(props) {
  ...
  const loadLineChart = async () => {
    axios({
      ...
      url: "http://localhost:8086/userAbonnement/statistics/line chart/" + lineChartYear,
      method: "GET",
    })
  ...
  const loadTotalClient = async () => {
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/total",
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const loadTotalP = async =>{
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/totalP",
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const loadTotalNP = async =>{
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/totalNP",
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const loadTotalRecharge = async =>{
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/totalR",
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const loadDonutChart = async () => {
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/donut_chart",
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const loadDonut2Chart = async () => {
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/donut_chart2/" + donutChartTel + "/" + donutChartYear,
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const loadLineChartRecharge = async () => {
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/line chart/recharge/" + lineChartYear,
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const handleChangeLineRecharge = (newValue) => {
    ...
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/line chart/recharge/" + newValue,
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const handleChangeDonutT = (newValue) => {
    ...
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/donut_chart2/" + newValue + "/" + donutChartYear,
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const handleChangeDonutY = (newValue) => {
    ...
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/donut_chart2/" + donutChartTel + "/" + newValue,
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const handleChangeLine = (newValue) => {
    ...
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/line chart/" + newValue,
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const loadBarChart = async () => {
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/bar chart/" + barChartYear,
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
  ...
  const handleChangeBar = (newValue) => {
    ...
    axios({
      // Endpoint to send files
      url: "http://localhost:8086/userAbonnement/statistics/bar chart/" + newValue,
      method: "GET",
    })
      // Handle the response from backend here
      .then((res) => {
