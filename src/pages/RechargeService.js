...
export default class RechargeService extends Component {
    ...
    counterNumber() {
        ...
        axios({
          ...
          url: "http://localhost:8083/operation/recharge/" + this.state.user.id,
          method: "GET",
        })
    ...
    handleUpload() {
        axios({
            ...
            // Endpoint to send files
            url: "http://localhost:8086/userAbonnement/getAllRecharges",
            method: "GET",
        })
    ...
    handleDelete() {
        ...
        axios({
            // Endpoint to send files
            url: "http://localhost:8086/userAbonnement/deleteRecharge/" + this.state.rowId,
            method: "DELETE",
        })
    ...
    onSubmit = async (e) => {
        this.setState({ montant: document.getElementById('selectMontant').value, tel: document.getElementById('selectPhone').value, operateur: document.getElementById('selectOperateur').value, type: document.getElementById('selectType').value },
            ...
            async () => {
                ...
                await axios.post("http://localhost:8086/userAbonnement/"+this.state.user.id+"/addRecharge", userRecharge)
                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center" >
                            ...
                            <button type="button" class="btn btn-primary mb-1" data-toggle="modal" data-target="#add" >Add reload</button>
